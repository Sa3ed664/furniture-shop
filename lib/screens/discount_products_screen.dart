...
class DiscountProductsScreen extends StatelessWidget {
  ...
  Future<List<Product>> _fetchDiscounted() async {
    try {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('المنتجات المخفضة')),
      body: FutureBuilder<List<Product>>(
        future: _fetchDiscounted(),
        builder: (context, snapshot) {
          ...
          if (products.isEmpty) {
            return const Center(child: Text('لا توجد منتجات مخفضة حاليًا'));
          }
